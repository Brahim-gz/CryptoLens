  ...
  return (
    <>
      ...
      <div className="rounded-3xl bg-primary col-start-17 lg:col-start-21 2xl:col-start-23 row-start-2 2xl:row-start-1 col-span-8 lg:col-span-4 2xl:col-span-2 row-span-1 lg:row-span-2">
        ...
        <FaChevronDown
          size={20}
          className="relative left-[85%] lg:left-[75%] xl:left-[80%] 2xl:left-[75%] bottom-[65%] xl:bottom-[60%] 2xl:bottom-[63%] pointer-events-none fill-White"
        />
      </div>
      <div
        className={`rounded-3xl col-start-1 lg:col-start-13 2xl:col-start-17 row-start-3 lg:row-start-4 py-2 2xl:py-0 2xl:row-start-3 col-span-24 lg:col-span-12 2xl:col-span-8 row-span-1 lg:row-span-2 text-2xl text-White flex items-center justify-between px-5 ${
