  ...
  return (
    <>
      <button
        ...
        className="group cursor-pointer rounded-3xl bg-secondary col-span-5 row-span-3 text-White text-4xl flex items-center justify-center gap-4"
      >
      ...
      <button
        onClick={() => navigate("/")}
        className="group cursor-pointer rounded-3xl bg-primary col-span-5 row-span-3 text-White text-4xl flex items-center justify-center gap-4 "
      >
        <LuArrowLeft
          size={40}
          className="group-hover:size-15 transition-all duration-100"
